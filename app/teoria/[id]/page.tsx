...
export default async function TheoryModulePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="flex-1 flex flex-col min-h-screen bg-[#151d18] text-[#EDE5D8] academic-paper-bg">
          ...
          <div className="flex items-center gap-2">
            {prevMod && (
              <Link
                ...
                className="px-3 py-1.5 rounded-lg text-xs font-medium bg-[#223028] text-[#EDE5D8] border border-[rgba(217,203,182,0.14)] hover:border-[#7A8F73] transition-all flex items-center gap-1"
            ...
            {nextMod && (
              <Link
                ...
                className="px-3 py-1.5 rounded-lg text-xs font-medium bg-[#7A8F73] text-[#141c17] hover:bg-[#8ba383] transition-all flex items-center gap-1 font-semibold"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-10 w-full grid lg:grid-cols-[1fr_260px] gap-8 items-start">
        {/* Main Content Column */}
        <article className="space-y-8 min-w-0">
          {/* Editorial Module Header */}
          <div className="academic-card-elevated rounded-2xl p-6 sm:p-8 space-y-4 border border-[rgba(217,203,182,0.18)] relative overflow-hidden">
              ...
              return (
                <section key={idx} id={sectionId} className="space-y-4 scroll-mt-20">
                  ...
                  {section.content.length > 0 && (
                    <div className="academic-card rounded-xl p-5 sm:p-6 space-y-4">

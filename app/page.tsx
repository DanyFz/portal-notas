...
export default function MainHubPage() {
  return (
    <main className="flex-1 flex flex-col items-center justify-center p-3.5 sm:p-8 bg-[#151d18] text-[#EDE5D8] academic-paper-bg min-h-screen">
      <div className="w-full max-w-5xl space-y-8 sm:space-y-12 py-6 sm:py-8 relative z-10">
        {/* Institutional Branding Header */}
        <header className="text-center space-y-3 sm:space-y-4 max-w-2xl mx-auto px-1">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#223028] border border-[rgba(217,203,182,0.15)] text-[11px] sm:text-xs text-[#C8B99D] font-medium mb-1 max-w-full text-center">
            <span className="w-1.5 h-1.5 rounded-full bg-[#7A8F73] shrink-0" />
            <span className="truncate sm:whitespace-normal">Universidad Nacional de Colombia · Sede Medellín</span>
          </div>

          <h1 className="text-2xl sm:text-4xl md:text-5xl font-serif font-bold tracking-tight text-[#FAF6EE] leading-tight">
            Portal Académico de Matemáticas Básicas
          </h1>

          <p className="text-[#A89F8D] text-xs sm:text-base leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8">
            ...
            <div className="academic-card-elevated rounded-2xl p-5 sm:p-8 h-full flex flex-col justify-between hover:border-[#7A8F73] transition-all relative overflow-hidden group-hover:-translate-y-1">
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center justify-between">
                  <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-[#223028] border border-[rgba(217,203,182,0.15)] flex items-center justify-center text-[#7A8F73] group-hover:bg-[#7A8F73] group-hover:text-[#141c17] transition-all">
                ...
                <div className="space-y-2 pt-3 sm:pt-4 border-t border-[rgba(217,203,182,0.08)] text-xs text-[#EDE5D8]/80">
                  <div className="flex items-center gap-2">
                    <span className="font-mono text-[#7A8F73] text-[11px]">01.</span>
                    <span>Álgebra y Fundamentos Numéricos (1–10)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="font-mono text-[#7A8F73] text-[11px]">02.</span>
                    <span>Ecuaciones, Geometría y Modelado (11–19)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="font-mono text-[#7A8F73] text-[11px]">03.</span>
                    <span>Funciones y Propiedades (20–25)</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="font-mono text-[#7A8F73] text-[11px]">04.</span>
          ...
          <Link href="/notas" className="group block focus:outline-none">
            <div className="academic-card-elevated rounded-2xl p-5 sm:p-8 h-full flex flex-col justify-between hover:border-[#7A8F73] transition-all relative overflow-hidden group-hover:-translate-y-1">
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center justify-between">
                  <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-[#223028] border border-[rgba(217,203,182,0.15)] flex items-center justify-center text-[#C8B99D] group-hover:bg-[#C8B99D] group-hover:text-[#141c17] transition-all">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 sm:w-6 sm:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
                ...
                <div className="space-y-2 pt-3 sm:pt-4 border-t border-[rgba(217,203,182,0.08)] text-xs text-[#EDE5D8]/80">
                  <div className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C8B99D] shrink-0" />
        ...
        <footer className="pt-6 sm:pt-8 border-t border-[rgba(217,203,182,0.12)] text-center text-xs text-[#A89F8D] space-y-1">
          <p className="leading-snug">Universidad Nacional de Colombia · Facultad de Ciencias · Escuela de Matemáticas</p>
